export const en = {
  ...
  other: {
    ...
    DepartmentMessage: "Department must be at least 2 characters.",
    ...
    SendAnEmail: "Send an email to the user with their login credentials.",
    AddNewUser: "Add a new user to the system. All fields marked with * are required.",
    RequirePassword: "Require password change on first login",
    TheUserWill: "The user will be prompted to change their password when they first log in.",
